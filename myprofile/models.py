...
class UserCategoryInterestModel(models.Model):
    user = models.OneToOneField(get_user_model(), on_delete=models.CASCADE, related_name="UserCategoryInterestModel_user")
...
class UserSavedPostsModel(models.Model):
    user = models.OneToOneField(get_user_model(), on_delete=models.CASCADE, related_name="UserSavedPostsModel_user")
...
class UserCourseModel(models.Model):
    user = models.OneToOneField(get_user_model(), on_delete=models.CASCADE, related_name="UserCourseModel_user")
...
class UserJobApplicationModel(models.Model):
    user = models.OneToOneField(get_user_model(), on_delete=models.CASCADE, related_name="UserJobApplicationModel_user")
...
class UserExaminationModel(models.Model):
    user = models.OneToOneField(get_user_model(), on_delete=models.CASCADE, related_name="UserExaminationModel_user")
