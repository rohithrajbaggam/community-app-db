...
from .serializers import UserProfileCreateSerializer, UserProfileListSerializer, UserResumeModelSerializer, UserAddressModelSerializer, UserEducationDetailsModelModelSerializer, UserExperienceDetailsModelSerializer, UserContactInfoModelSerializer
